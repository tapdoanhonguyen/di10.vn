        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6">
                <div class="form-group">
                    ...
                    <a class="btn btn-success"  href="{add_scenario_detail}">{LANG.add_mailmarketing}</a>
                </div>
            </div>
        </div>
    </form>
    ...
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            ...
            <tr>
                ...
                <th>{LANG.title_mail}</th>
                <th>{LANG.content_mail}</th>
...
<form class="form-inline m-bottom pull-left">
    ...
    <button class="btn btn-primary" onclick="nv_list_action( $('#action').val(), '{BASE_URL}', '{LANG.error_empty_data}' ); return false;">{LANG.action}</button>
</form>
<!-- END: main -->
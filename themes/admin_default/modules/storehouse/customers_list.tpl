		    ...
		    <div class="table-responsive">
		        <table class="table table-striped table-bordered table-hover">
		            ...
		            <tbody>
		                ...
		                <tr>
		                    <td> {VIEW.number} </td>
		                    <td> {VIEW.saleagent} </td>
		                    <td> {VIEW.name} </td>
		                    <td> {VIEW.company} </td>
		                    <td> {VIEW.address} </td>
		                    <td> {VIEW.phone} </td>
		                    <td> {VIEW.email} </td>
		                    <td class="text-center"><i class="fa fa-edit fa-plus">&nbsp;</i> <a href="{VIEW.link_add_project}">{LANG.add}</a> <i class="fa fa-edit fa-lg">&nbsp;</i> <a href="{VIEW.link_edit}#edit">{LANG.edit}</a> - <em class="fa fa-trash-o fa-lg">&nbsp;</em> <a href="{VIEW.link_delete}" onclick="return confirm(nv_is_del_confirm[0]);">{LANG.delete}</a></td>
		                </tr>
		                <!-- END: loop -->
		            </tbody>
		        </table>

...
<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
    ...
    <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.store_name}</strong> <span class="red">(*)</span></label>
    ...
    <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.admin}</strong></label>
        <div class="col-sm-19 col-md-20">
            <input title="{LANG.search_id}" class=" txt" type="text" name="uid" id="uid" value="{ROW.userid}" maxlength="11" style="width:50px" />

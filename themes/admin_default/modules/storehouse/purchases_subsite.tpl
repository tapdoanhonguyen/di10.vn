		        ...
		        <table class="table table-striped table-bordered table-hover">
		            ...
		            <tbody>
		                ...
		                <tr>
		                    ...
		                    <td class="text-center"><i class="fa fa-eye fa-lg">&nbsp;</i> <span class="view_purchase" ><a href="{VIEW.link_view}" >{LANG.view_purchase}</a></span> - <i class="fa fa-money fa-lg">&nbsp;</i> <span class="add_payment" purchases_id="{VIEW.id}" money="{VIEW.money_nofomart}">{LANG.add_payment}</span> - <i class="fa fa-print fa-lg">&nbsp;</i> <a href="#" onclick="printExternal('{VIEW.link_print}')">{LANG.print}</a> </td>
		                </tr>
		                <!-- END: loop -->
		            </tbody>
		        </table>

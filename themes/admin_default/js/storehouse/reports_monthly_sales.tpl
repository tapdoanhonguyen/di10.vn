...
<div class="col-lg-24">
	...
	<div class="box">
		 <div class="box-content">
		 	<div class="row">
	            <div class="col-lg-24">
	                <p class="introtext">{LANG.get_day_profit} {LANG.reports_calendar_month_text}</p>
	
	                <div class="table-responsive">
	                	<table class="table table-bordered table-striped dfTable reports-table">
	                        <thead>
	                        <tr class="year_roller">
	                            <th><a class="white" href="{link_year_old}">&lt;&lt;</a></th>
	                            <th colspan="10"> {year}</th>
	                            <th><a class="white" href="{link_year_new}">&gt;&gt;</a></th>
	                        </tr>
	                        </thead>
	                        <tbody>
		                        <tr>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/01" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_january}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/02" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_february}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/03 " data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_march}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/04" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_april}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/05" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_may}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/06" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_june}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/07" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_july}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/08" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_august}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/09" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_september}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/10" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_october}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/11" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_november}
		                                </a>
		                            </td>
		                            <td class="bold text-center">
		                                <a href="reports/monthly_profit/{year}/12" data-toggle="modal" data-target="#myModal">
		                                    {LANG.cal_december}
		                                </a>
		                            </td>
		                        </tr>

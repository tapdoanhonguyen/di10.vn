					...
					<table class="table table-striped table-bordered table-hover">
						<tbody>
						   ...
						   <tr class="required">
							...
							<tr class="required">
								<td style="width:200px">{LANG.customer_id}</td>
								<td>
					...
					<tbody class="ui-sortable products">
						...
						<tr>
							...
							<td> <select class="form-control" name="product[]" id="products_id_{product.i}" ></select>
								...
								<script type="text/javascript">$(document).ready(function() {product_sales_select("products_id_{product.i}",{product.i},{product.id}); });</script>
							</td>
							<td> <input type="text" class="form-control" name="product_expried[]" value="{product.expried}"></td>
							<td> 
								<input type="hidden" name="product_net_cost[]" value="{product.price}">
								<input type="hidden" name="product_unit_cost[]" value="{product.price}">
								<input type="text" class="form-control" name="product_real_unit_cost[]" value="{product.price}">
							</td>
							<td>
								<input type="text" class="form-control" name="product_base_quantity[]" value="{product.quantity}">
								<input type="hidden" name="product_unit[]" value="{product.sales_unit}" id="pro_pc_unit_{product.i}">
							</td>
							...
							<td>
								<input type="text" class="form-control" name="product_total[]" value=" {product.total}"> 
							</td>
							<td> </td>
						</tr>
						<!-- END: products -->

...
<div class="col-lg-24">
	...
	<script type="text/javascript">
        ...
        $('#m2bschart').highcharts({
            ...
            series: [{
                name: '{LANG.sold}',
                data: [<!-- BEGIN: m2loop -->['{M2BS.product_name}', {M2BS.total_quantity}],<!-- END: m2loop -->],
                dataLabels: {
                    enabled: true,
                    rotation: -90,
                    color: '#000',
        ...
        $('#m1bschart').highcharts({
            ...
            series: [{
                name: '{LANG.sold}',
                data: [<!-- BEGIN: m1loop -->['{M1BS.product_name}', {M1BS.total_quantity}],<!-- END: m1loop -->],
                dataLabels: {
                    enabled: true,
                    rotation: -90,
                    color: '#000',
        ...
        $('#m3bschart').highcharts({
            ...
            series: [{
                name: '{LANG.sold}',
                data: [<!-- BEGIN: m3loop -->['{M3BS.product_name}', {M3BS.total_quantity}],<!-- END: m3loop -->],
                dataLabels: {
                    enabled: true,
                    rotation: -90,
                    color: '#000',
        ...
        $('#m4bschart').highcharts({
            ...
            series: [{
                name: '{LANG.sold}',
                data: [<!-- BEGIN: m4loop -->['{M4BS.product_name}', {M4BS.total_quantity}],<!-- END: m4loop -->],
                dataLabels: {
                    enabled: true,
                    rotation: -90,
                    color: '#000',

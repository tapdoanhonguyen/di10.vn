                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div id="priceproduct">
							...
							<!-- BEGIN: admin_price_cost -->
							<div class="form-group">
                                <label class="col-md-4 control-label">{LANG.content_product_product_cost}</label>
                                <div class="col-md-8">
                                    <input class="form-control" type="text" maxlength="50" value="{rowcontent.cost}" name="cost" onkeyup="this.value=FormatNumber(this.value);" id="f_money" />
                                </div>
                            </div>
							<!-- END: admin_price_cost -->
                            <!-- BEGIN: typeprice2 -->
                            <div class="form-group">
                                <label class="col-md-4 control-label">{LANG.affiliate_groups}</label>
                                <div class="col-md-15">
                                    <table id="id_price_configs" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th class="text-center">{LANG.affiliate}</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{AFFILIATE.title}
												<input class="form-control" type="hidden" name="price_config[{AFFILIATE.id}][number_to]" value="{AFFILIATE.id}" /></td>
                                                <td><input class="form-control" type="text" name="price_config[{AFFILIATE.id}][price]" value="{PRICE_CONFIG.price}" onkeyup="this.value=FormatNumber(this.value);" style="text-align: right" /></td>
                                            </tr>
                                            <!-- END: loop -->
                                        </tbody>
                                    </table>

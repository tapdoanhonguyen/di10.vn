    ...
    <div class="col-xs-12 col-sm-12 col-md-{num}">
        <div class="thumbnail product-item">
            <div class="product-img" style="height: {height}px">
                <a href="{link_pro}" title="{title_pro}"><img src="{img_pro}" alt="{title_pro}" <!-- BEGIN: tooltip_js -->data-content='{intro}' data-rel="tooltip" data-img="{img_pro}"<!-- END: tooltip_js --> class="img-thumbnail" style="max-height:{height}px;max-width:{width}px;background-color: #fff;"></a>
            </div>
            <div class="info_pro">
            	<!-- BEGIN: new -->
            ...
            <div class="caption text-center product-info" style="padding: 0px;margin-top: 15px;">
                ...
                <a href="{link_pro}" title="{title_pro}">{title_pro0}</a>
				</div>
                <!-- BEGIN: adminlink -->
                <p>{ADMINLINK}</p>
                <!-- END: adminlink -->

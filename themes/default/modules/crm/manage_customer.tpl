        ...
        <table class="table table-striped table-bordered table-hover row-click">
            <thead>
                <tr>
                    ...
                    <th><!-- BEGIN: first_name_no --> <em class="fa fa-sort">&nbsp;</em> <!-- END: first_name_no --> <!-- BEGIN: first_name --> <!-- BEGIN: desc --> <em class="fa fa-sort-numeric-desc">&nbsp;</em> <!-- END: desc --> <!-- BEGIN: asc --> <em class="fa fa-sort-numeric-asc">&nbsp;</em> <!-- END: asc --> <!-- END: first_name --> <a href="{SORTURL.first_name}" title="">{LANG.first_name}</a></th>
                    <th>{LANG.main_phone}</th>
                    <th>{LANG.main_email}</th>
                    <th width="150"><!-- BEGIN: addtime_no --> <em class="fa fa-sort">&nbsp;</em> <!-- END: addtime_no --> <!-- BEGIN: addtime --> <!-- BEGIN: desc --> <em class="fa fa-sort-numeric-desc">&nbsp;</em> <!-- END: desc --> <!-- BEGIN: asc --> <em class="fa fa-sort-numeric-asc">&nbsp;</em> <!-- END: asc --> <!-- END: addtime --> <a href="{SORTURL.addtime}" title="">{LANG.addtime}</a></th>
                    <th width="150">&nbsp;</th>
                </tr>
            </thead>
            <!-- BEGIN: generate_page -->

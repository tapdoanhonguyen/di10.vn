...
if (!nv_function_exists('nv_sanpham_group_product')) {

    /**
     * nv_block_config_sanpham_hutkhach_blocks()
     *
     * @param mixed $module
     ...
     *
     */
    function nv_block_config_sanpham_group_blocks($module, $data_block, $lang_block)
    {
    ...
    /**
     * nv_block_config_sanpham_hutkhach_blocks_submit()
     *
     * @param mixed $module
     * @param mixed $lang_block
     * @return
     *
     */
    function nv_block_config_sanpham_group_blocks_submit($module, $lang_block)
    {
        global $nv_Request;
        $return = array();
        $return['error'] = array();
     ...
     *
     */
    function nv_sanpham_group_product($block_config)
    {
		...
		if (file_exists(NV_ROOTDIR . '/themes/' . $global_config['module_theme'] . '/blocks/global.block_sanpham_group.tpl')) {
            $block_theme = $global_config['module_theme'];
        } elseif (file_exists(NV_ROOTDIR . '/themes/' . $global_config['site_theme'] . '/blocks/global.block_sanpham_group.tpl')) {
		...
		$xtpl = new XTemplate('global.block_sanpham_group.tpl', NV_ROOTDIR . '/themes/' . $block_theme . '/blocks');
...
if (defined('NV_SYSTEM')) {
    $content = nv_sanpham_group_product($block_config);
}

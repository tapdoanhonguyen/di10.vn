...
$groups_list = nv_groups_storehouse_list($module_data);
...
if ($nv_Request->isset_request('confirm', 'post')) {
    ...
    $_user['first_name'] = nv_substr($nv_Request->get_title('username', 'post', '', 1), 0, 255);
    $_user['last_name'] = nv_substr($nv_Request->get_title('username', 'post', '', 1), 0, 255);
    ...
    $custom_fields['first_name'] = $_user['username'];
    $custom_fields['last_name'] = $lang['staff'];
...
$xtpl->assign('FORM_ACTION', NV_BASE_ADMINURL . 'index.php?' . NV_LANG_VARIABLE . '=' . NV_LANG_DATA . '&amp;' . NV_NAME_VARIABLE . '=' . $module_name . '&amp;' . NV_OP_VARIABLE . '=users_add');

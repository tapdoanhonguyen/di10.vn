...
namespace NukeViet\StoreHouse\Stdlib;

use NukeViet\StoreHouse\Stdlib\StringWrapper\StringWrapperInterface;
    ...
    public static function getRegisteredWrappers()
    {
        if (static::$wrapperRegistry === null) {
            ...
            if (extension_loaded('intl')) {
                static::$wrapperRegistry[] = 'NukeViet\StoreHouse\Stdlib\StringWrapper\Intl';
            }

            if (extension_loaded('mbstring')) {
                static::$wrapperRegistry[] = 'NukeViet\StoreHouse\Stdlib\StringWrapper\MbString';
            }

            if (extension_loaded('iconv')) {
                static::$wrapperRegistry[] = 'NukeViet\StoreHouse\Stdlib\StringWrapper\Iconv';
            }

            static::$wrapperRegistry[] = 'NukeViet\StoreHouse\Stdlib\StringWrapper\Native';
        }

...
namespace NukeViet\StoreHouse\Object;

use Traversable;
use NukeViet\StoreHouse\Barcode;
use NukeViet\StoreHouse\Stdlib\ArrayUtils;
use NukeViet\StoreHouse\Validator\Barcode as BarcodeValidator;
...
abstract class AbstractObject implements ObjectInterface
{
     ...
     * @var string
     */
    protected $barcodeNamespace = 'NukeViet\StoreHouse\Object';
    ...
    public function __construct($options = null)
    {
        ...
        $this->font = Barcode::getBarcodeFont();
